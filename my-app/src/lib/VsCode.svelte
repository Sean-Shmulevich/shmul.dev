...
" on:mousedown={incrementCount}>
    <div class="vsAppBar" style="cursor:move" use:asDraggable={{relativeTo:document.body, onDragStart, onDragMove, onDragEnd, minX:0,minY:0}}>
        <div style="margin-left: 6px;">
            <div class="fakeButtons fakeClose vsControlButtons" on:mousedown={forward}></div>
            <div class="fakeButtons fakeMinimize vsControlButtons"></div>
        ...
        <div class="barSearch">
            ...
            <div style="display:flex;width: inherit;">
                ...
                <input class="barSearchInput" id="text17" type="text" style="box-shadow: unset;border-radius: 5px;background-color: rgb(36,36,64);border: 1px solid rgb(180 153 72);"/>
            </div>
        </div>
        <div class="layoutBox">
    ...
    <div class="vsBottomBar">
        ...
        <div style="display:flex;margin-left: auto;flex-direction: row-reverse;">             
            <div class='codicon codicon-bell' style="color: rgb(160,151,229);margin-left: auto;margin-right: 8px;transform: scale(0.9);margin-top:1px"></div>
            <div class='codicon codicon-squirrel' style="color: rgb(160,151,229);margin-left: auto;margin-right: 4px;transform: scale(0.9);margin-top:1px"></div>
            <div class='codicon codicon-terminal-powershell' style="color: rgb(160,151,229);margin-left: auto;margin-right: 6px;transform: scale(0.9);margin-top:1px"></div>

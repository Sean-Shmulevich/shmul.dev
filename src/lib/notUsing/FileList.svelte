...
{#if !hide}
  ...
  >
    <div
      class="title-bar linksBar windowBar"
      use:asDraggable={{
    ...
    >
      ...
      <div
        ...
        style="float: right;margin-right: 5px;padding-top: 5px;"
      >
        <button
          class="minimize"
          style="min-width: 15px;background-color: #ff2121;"
          aria-label="Minimize"
          on:click={() => (hide = true)}
        ></button>
        <button
          class="full"
          style="min-width: 15px;margin-left: 2px;background-color: #ffcf21;"
          aria-label="Maximize"
        ></button>
        <button
          class="close"
          on:mousedown={forward}
          style="min-width: 15px;background-color: #21ff3f;"
          aria-label="Close"
        ></button>
      </div>
    </div>
    ...
    <div
      style="border: 1px solid #000000;display: inline-block;width: inherit;"
    >

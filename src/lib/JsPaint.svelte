<script>
  ...
  onMount(() => {
    ...
    if (touchDevice) {
      ...
      document.getElementById("jsBar").addEventListener(
        "touchstart",
        (mobileDblTap = (e) => {
...
>
  ...
  >
    ...
    >
      <span
        class="filesBarText"
        style="display: block;transform: translateY(-4px);">JS Paint</span
      >
    </div>
    <div
  ...
  <div
    style="border: 1px solid #000000;display: inline-block;width: 100%;margin-top: -6px; height: inherit;max-height: 625px;"
  >
    <div
    ...
    >
      <div class="window-body" style="height: calc(100% - 35px);margin:0px">
        <iframe
          title="Javascript paint application"
          class:mouseOn={zIdx === $count["zIdx"]}

...
>
  ...
  >
    <div
      ...
      style="text-align:right;float:left;font-size: 10px;margin-left: 10px;margin-top: -1px;"
    >
      Overview
    </div>
    <div
  ...
  <div style="padding: 10px 10px 30px;height: 366px;">
    <div class="SubMenu">
      <div
        class="SubMenuTabs"
        style="height: 21px;z-index: 1;user-select: none;display: flex"
      >
        <label
          class="SubMenuTab radioTab"
          class:selectedTab={value === "Hello"}
          style="display: unset"
        >
          <input
            type="radio"
        ...
        <label
          class="SubMenuTab radioTab"
          style="display: unset"
          class:selectedTab={value === "Skills"}
        >
          <input
            type="radio"
            bind:group={value}
        ...
        <label
          class="SubMenuTab radioTab"
          class:selectedTab={value === "Contact"}
          style="display: unset"
        >
          <input
            type="radio"
        ...
        <label
          class="SubMenuTab radioTab"
          class:selectedTab={value === "Mobile"}
          style="display: unset"
        >
          <input
            type="radio"
          ...
          <div style="width: 100%;padding: 20px;line-height: 1.5;">
            {#if value == "Hello"}
              <div style="display:flex">
                <img
                  class="aboutImage"
                  src="https://avatars.githubusercontent.com/u/33522108?v=4"
                  width="150"
                  style="margin-top:-20px;min-width:70%;border-radius:50%;margin-left:-30px"
                  alt="Sean Shmulevich profile"
                />
            ...
            {:else if value === "Skills"}
              <div class="aboutContent" style="margin-top:-20px">
                ...
                <div style="font-family: 'Apple Garamond';font-size:1rem">
                  python (django, selnium, scrapy, pandas, Flask, SqlAlchemy),
                  Java, Javascript (Node.js, React, Svelte), C, Rust, SCSS,
                  Tailwind Css, Bash, Git, ZSH, regular expressions.
                </div>
              </div>
            {:else if value === "Contact"}
              <h2 class="contactText" style="margin-top:-40px;margin-left:15%">
                {value} Me
              </h2>
              <form
                id="submitMessage"
              ...
              >
                <input
                  type="hidden"
                  name="access_key"
                  value="fc0096dc-43af-400b-b33a-034020091036"
                />
                <div
                  class="field-row-stacked"
                  style="width: 330px;margin-top:-40px;margin-left:-32px"
                >
                  <label
                    class="messageText"
                    for="text20"
                    style="margin-inline: auto;">Message</label
                  >
                  <textarea
                    name="message"
                    id="text20"
            ...
            {:else if value === "Mobile"}
              <div class="aboutContent">
                <h2>{value}</h2>
                <div style="font-family: 'Apple Garamond';font-size:1rem">
                  This website has been optimized for mobile! try swiping down
                  on the windows or double tapping the app bar to minimize the
                  window.
                  <br /><br />
    ...
    <button
      class="CloseButton submit"
      on:mousedown={forward}
      on:touchstart={forward}>Cancel</button
    >
    <button
      class="CloseButton submit"
      on:mousedown={minFunc}
      on:touchstart={minFunc}>OK</button
    >
  </div>
</div>

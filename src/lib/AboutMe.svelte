                    ...
                    <div style="width: 100%;padding: 20px;line-height: 1.5;">
                        ...
                        {:else if value === "Skills"}
                            <div class="aboutContent" style="margin-top:-20px">
                                ...
                                <div
                                    style="font-family: 'Apple Garamond';font-size:1rem"
                                >
                                    python (django, selnium, scrapy, pandas,
                                    Flask, SqlAlchemy), Java, Javascript
                                    (Node.js, React, Svelte), C, Rust, SCSS,
                                    Tailwind Css, Bash, Git, ZSH, regular
                                    expressions.
                                </div>
                            </div>
                        ...
                        {:else if value === "Mobile"}
                            <div class="aboutContent">
                                ...
                                >
                                    ...
                                    try swiping down on the windows or double
                                    tapping the app bar to minimize the window.
                                    <br /><br />
                                    Also try dragging in the corner of 'VSCode' to
                                    resize.
                                </div>
                            </div>
                        {/if}
